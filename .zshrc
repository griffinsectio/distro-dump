...
ZSH_HIGHLIGHT_STYLES[command]='fg=#89dceb'
ZSH_HIGHLIGHT_STYLES[comment]='fg=#707070'
ZSH_HIGHLIGHT_STYLES[path]='fg=#cba6f7'
ZSH_HIGHLIGHT_STYLES[single-hyphen-option]='fg=#a6e3a1'
ZSH_HIGHLIGHT_STYLES[double-hyphen-option]='fg=#a6e3a1'
